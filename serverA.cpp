...
#define PORT 21099 //Port# is 21000 + last 3 digits of student_id (2336080_099_) -> 21099
#define MAXLINE 1024
#define BLOCK_FILE "block1.txt" // Path to the transaction file
